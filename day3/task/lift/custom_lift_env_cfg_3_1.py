    ...
    table: AssetBaseCfg = AssetBaseCfg(
        ...
        spawn=sim_utils.CuboidCfg(
            ...
            visual_material=sim_utils.PreviewSurfaceCfg(
                diffuse_color=(0.5, 0.5, 0.5), metallic=0.2, roughness=0.5
            ),
            physics_material=sim_utils.RigidBodyMaterialCfg(
                static_friction=0.8, dynamic_friction=0.5, restitution=0.1
            ),
...
class ActionsCfg:
    ...
    # Agent 환경에서 채워지는 값
    arm_action: (
        mdp_3_1.JointPositionActionCfg | mdp_3_1.DifferentialInverseKinematicsActionCfg
    ) = MISSING
...
class EventCfg:
    ...
    reset_all = EventTerm(func=mdp_3_1.reset_scene_to_default, mode="reset")
...
class TerminationsCfg:
    ...
    object_reach_goal = DoneTerm(func=mdp_3_1.object_reached_goal)
