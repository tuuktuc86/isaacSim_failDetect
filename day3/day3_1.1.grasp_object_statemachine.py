...
class PickAndPlaceSm:
    ...
    def __init__(self, dt: float, num_envs: int, device: torch.device | str = "cpu", position_threshold=0.01):
        ...
        self.ready_pose = torch.tensor([[ 0.3, 0,  0.65, 0,  1, 0, 0]], device=self.device)  # (x, y, z, qw, qx, qy, qz)
...
def main():
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            for env_num in range(num_envs):
                ...
                if pick_and_place_sm.sm_state[env_num] == PickAndPlaceSmState.PREDICT:
                    ...
                    if pc is not None:
                        ...
                        # grasp_pos는 pregrasp_pos의 z축을 기축으로 0.09m 떨어진곳으로 배치
            ...
            ee_frame_sensor.cfg.debug_vis = False # 디버그 시각화 비활성화
