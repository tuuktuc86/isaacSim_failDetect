...
from task.lift.config.ik_abs_env_cfg_2_4_3_example import FrankaCubeLiftEnvCfg
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            if dones.any():
                ...
                #("Environment reset. Resetting state machine.")
